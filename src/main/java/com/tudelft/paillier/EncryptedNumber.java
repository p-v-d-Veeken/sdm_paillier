...
public final class EncryptedNumber {
   ...
   * {@link com.tudelft.paillier.PaillierPrivateKey#decrypt(EncryptedNumber)} for more details.
   *
   ...
   * See {@link com.tudelft.paillier.PaillierContext#decreaseExponentTo(EncryptedNumber, int)} for details.
   *
   ...
   * {@link com.tudelft.paillier.PaillierContext#add(EncryptedNumber, EncryptedNumber)} for more details.
   *
   ...
   * {@link com.tudelft.paillier.PaillierContext#add(EncryptedNumber, EncodedNumber)} for more details.
   *
