...
import com.tudelft.paillier.util.HashChain;
...
public final class EncodedNumber {
   ...
   * {@link com.tudelft.paillier.PaillierContext#decodeBigInteger(EncodedNumber)} for details.
   *
   ...
   * {@link com.tudelft.paillier.PaillierContext#decodeDouble(EncodedNumber)} for details.
   *
   * @return the decoded number.
   ...
   * {@link com.tudelft.paillier.PaillierContext#decodeLong(EncodedNumber)} for details.
   *
   * @return the decoded number.
   ...
   * See {@link com.tudelft.paillier.PaillierContext#decreaseExponentTo(EncodedNumber, int)} for details.
   *
   ...
   * {@link com.tudelft.paillier.PaillierContext#encrypt(EncodedNumber)} for details.
   *
   ...
   * {@link com.tudelft.paillier.PaillierContext#add(EncodedNumber, EncryptedNumber)} for details.
   *
   ...
   * {@link com.tudelft.paillier.PaillierContext#add(EncodedNumber, EncodedNumber)} for details.
   *
